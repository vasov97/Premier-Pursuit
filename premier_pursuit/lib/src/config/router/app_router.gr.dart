...
/// generated route for
/// [EndScoreView]
class EndScoreRoute extends PageRouteInfo<void> {
  const EndScoreRoute({List<PageRouteInfo>? children})
      : super(
          EndScoreRoute.name,
          initialChildren: children,
        );
...
class VideoRouteArgs {
  ...
  @override
  String toString() {
    return 'VideoRouteArgs{key: $key, cameraController: $cameraController}';
  }
}
